...
echo color("red","   [♡] DIWOCO SIK YO GAYS\n");
echo color("purple","[♥] NGETIK NOMORNYA BEGINI YA 62xxxxxxxxxx \n");
echo color("nevy","  [♡] JANGAN LUPA FOLLOW IG GUE YA : @Lisin_94 \n");
echo color("yellow","[♥] DI SIBCRIBE YOUTUBE E YO KENO JENENGE LISIN GENIOUS\n");
echo color("blue"," [♡] GRATIS SCRIPT E BAYAR FOLLOW DAN SUBCRIBE WES SENENG\n");
echo color("purple"," [♥] NDANG LEK DI GASS MUMPUNG ISO\n");
echo color("green","# # # # # # # # # # # # # # # # # # # # # # # \n");
	echo "\n";
echo "\e[92m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
...
else
{
		...
		echo "\e[92m[🚫]           \e[91mSEGERA MINTA IZIN          \e[92m [🚫]\n";
	        echo "\e[92m[🚫]          \e[91mIG :@LISIN_94     \e[92m [🚫]\n";
		echo "\e[91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
goto login;
}
	return rtrim( $input, "\n" );
...
// function change(){
	...
	gocar:
        ...
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("red","🔓▶️ Message: ".$message);
        echo "\n".color("yellow","🔐▶️ INI VOC REFRESH AXE GAYS");
        echo "\n".color("green","⏳▶️ Please wait");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(5);
