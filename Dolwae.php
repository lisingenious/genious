...
echo "\n";
           ...
           echo "\n".color("green","馃憣馃嵄 Ambil Voucher HARBOLNASMART ");
        ...
        echo "\n".colorss("green","馃憤馃檹 Message: ".$message);
        }else{
        echo "\n".colorss("red","-] Message: ".$message);
        sleep(7);
}
echo "\n".color("green","馃憣馃嵄 Ambil Voucher GOMART ");
        echo "\n".color("nevy","Berdoa dulu bro.. ");
        for($a=1;$a<=3;$a++){
        echo color("blue","馃憖 ");
        sleep(10);
        ...
        $message = fetch_value12($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai')){
        echo "\n".color("green","馃憤馃檹 Message: ".$message);
        }else{
...
echo "\n".color("green","馃憣馃嵄 Ambil Voucher GOMART ");
        ...
        $code1 = requestedd('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"KEALFAYUK"}');
        $message = fetch_value12($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai')){
        echo "\n".colorss("green","馃憤馃檹 Message: ".$message);
        }else{
        ...
        echo "\n".color("green","馃憣馃嵄 Ambil Voucher ACAK ");
        echo "\n".color("nevy","Berdoa dulu bro.. ");
        for($a=1;$a<=3;$a++){
        echo color("blue","馃憖 ");
        sleep(8);
        ...
        echo "\n".colorss("red","鈽狅笍鈽狅笍 Message: ".$message);
	    gofood:
